...
class MasterContainerViewController: UIViewController,SegueHandler {
...
extension MasterContainerViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "embedSegue" {
            let dvc = segue.destination as! QuestionContainerViewController
            dvc.delegate = self
        }
    }
}
...
extension MasterContainerViewController: AVCaptureFileOutputRecordingDelegate {
...
extension MasterContainerViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
